...
# BMC
set_property PACKAGE_PIN AR20 [get_ports {msp_gpio[0]}]
set_property IOSTANDARD LVCMOS12 [get_ports {msp_gpio[0]}]
set_property PACKAGE_PIN AM20 [get_ports {msp_gpio[1]}]
set_property IOSTANDARD LVCMOS12 [get_ports {msp_gpio[1]}]
set_property PACKAGE_PIN AM21 [get_ports {msp_gpio[2]}]
set_property IOSTANDARD LVCMOS12 [get_ports {msp_gpio[2]}]
set_property PACKAGE_PIN AN21 [get_ports {msp_gpio[3]}]
...
set_property -dict {LOC AM10} [get_ports pcie_refclk_n]
